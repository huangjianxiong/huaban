...
// 	this.history=[];
// 	this.fillStyle='#000000';//fillStyle 属性设置或返回用于填充绘画的颜色、渐变或模式。
// 	this.strokeStyle='#000000';//strokeStyle 属性设置或返回用于笔触的颜色、渐变或模式
// 	this.type='stroke';
// 	this.lineWidth=2;//行距
// 	this.lineCap='round';//lineCap 属性设置或返回线条末端线帽的样式。
// 	this.img=obj.image;
        ...
        self.mask.onmousedown=function(e){
            ...
            self.area.onmousedown=function (e) {
                ...
                self.area.onmousemove=function (e) {
                    ...
                    let cx = e.clientX, cy = e.clientY;  //据浏览器的位置
